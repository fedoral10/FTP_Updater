 ...
 *  ----------------------------------------------------------------------------
 *  File:       		DownloadCompletedEventArgs.cs
...
namespace Laedit.Net
{
    ...
    /// </summary>
    public class DownloadCompletedEventArgs : FTPEventArgs
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="fTPFileName">Name of the f TP file.</param>
        /// <param name="fileName">Name of the file.</param>
        /// <param name="error">The error.</param>
        public DownloadCompletedEventArgs(String fTPFileName, String fileName, Exception error)
            : base(error)
        {
